...
x7(:,i)=(q(:,i)-(rand(n,1)*(q(:,i)-m(:,i)))); %constraint: m<=x7<=q
...
myu15(:,i)=1;                                % myu15=derajat keanggotaan 5 batas kanan (q) (tetap) 
...
y15=1;                                       % y15=derajat keanggotaan ideal 5 batas kanan (q) adalah 1 (tetap)
...
mse(:,i)=(((y1-myu1(:,i)).^2)+((y2-myu2(:,i)).^2)+((y3-myu3(:,i)).^2)+((y4-myu4(:,i)).^2)+((y5-myu5(:,i)).^2)+...
    ...
    ((y12-myu12(:,i)).^2)+((y13-myu13(:,i)).^2)+((y14-myu14(:,i)).^2)+((y15-myu15(:,i)).^2))/15;
